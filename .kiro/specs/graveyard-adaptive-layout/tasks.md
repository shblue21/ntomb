...
- [x] 1. Add LayoutConfig struct and constants
  - [x] 1.1 Define LayoutConfig struct with ring radii fields and is_adaptive flag
    - Add struct to `src/ui/graveyard.rs`
    - Include fields: ring_low, ring_medium, ring_high, edge_padding, is_adaptive
    - _Requirements: 1.1, 2.1_
  - [x] 1.2 Add adaptive layout constants
    - Define ADAPTIVE_THRESHOLD, RING_RATIO_LOW/MEDIUM/HIGH, EDGE_PADDING_PERCENT, MIN_EDGE_PADDING
    - _Requirements: 1.3, 1.4_

- [x] 2. Implement calculate_layout_config function
  - [x] 2.1 Create calculate_layout_config function
...
- [x] 3. Update calculate_endpoint_position function
  - [x] 3.1 Modify calculate_endpoint_position to accept LayoutConfig
...
- [x] 4. Integrate adaptive layout into render_network_map
  - [x] 4.1 Update render_network_map to use adaptive layout
...
- [x] 5. Update draw_latency_rings function
  - [x] 5.1 Modify draw_latency_rings to accept LayoutConfig
    - Change function signature to include layout: &LayoutConfig parameter
...
- [x] 7. Write unit tests for edge cases
  - [x] 7.1 Add unit tests for calculate_layout_config
